const tools = [
  {
    ...
    svg: (
        ...
        />
        <path
          d="M19 38v9.5a9.5 9.5 0 1 0 9.5-9.5H19z"
          fill="#1ABCFE"
        />
      </svg>
    ),
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 48 48" fill="none" className="h-14 w-auto md:h-16">
        <defs>
          <linearGradient id="gammaGrad" x1="0" y1="0" x2="48" y2="48" gradientUnits="userSpaceOnUse">
        ...
        />
        <path
          d="M24 18l-6 3.33v6.67L24 31.33l6-3.33v-6.67L24 18z"
          fill="#fff"
          opacity="0.25"
        />
      </svg>
    ...
    <section className="py-20 md:py-28 overflow-hidden">
      <div className="container-editorial mb-16 md:mb-20 flex items-end justify-between flex-wrap gap-4">
        <div>
          ...
          <h2 className="serif text-4xl md:text-5xl mt-3 max-w-xl">Tools I reach for, every day.</h2>
        </div>
      </div>
